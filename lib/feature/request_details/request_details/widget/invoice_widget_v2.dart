...
import 'package:vivas/feature/request_details/request_details/widget/payment_methods_widget_v2.dart';
...
class InvoiceWidgetV2 extends BaseStatelessWidget {
  ...
  InvoiceWidgetV2({super.key, required this.invoiceApiModel,required this.payWithPayLaterClickedCallBack, required this.payWithOnlineClickedCallBack});
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            _invoiceInfoItem(
                                ...
                                AppDateFormat.formattingMonthDay(
                                    DateFormat("MM/d/yyyy").parse("${invoiceApiModel.invoiceIssueDate}"),
                                    appLocale.locale.languageCode)),
                            _invoiceInfoItem(translate(LocalizationKeys.invoiceNo)!,
                                invoiceApiModel.invoiceCode??""),
                          ],
                        ),
                        SizedBox(height: 16.h),
                        Row(
                          ...
                          children: [
                            _invoiceInfoItem(
                                ...
                                AppDateFormat.formattingMonthDay(
                                    DateFormat("MM/d/yyyy").parse("${invoiceApiModel.invoiceStartDate}"),
                                    appLocale.locale.languageCode)),
                            _invoiceInfoItem(
                                translate(LocalizationKeys.endDate)!,
                                AppDateFormat.formattingMonthDay(
                                    DateFormat("MM/d/yyyy").parse("${invoiceApiModel.invoiceEndDate}"),
                                    appLocale.locale.languageCode)),
                          ],
                        ),
                        SizedBox(height: 16.h),
                        ...
                        _invoicePaymentItem(
                            ...
                            invoiceApiModel.secuirtyDeposit??0),
                        if (invoiceApiModel.serviceFees != 0) ...[
                          SizedBox(height: 12.h),
                          _invoicePaymentItem(
                              translate(LocalizationKeys.serviceFee)!,
                              invoiceApiModel.serviceFees??0,
                              subTitle: translate(
                        ...
                        const DashDividerWidget(),
                        SizedBox(height: 16.h),
                        _invoiceTotal(invoiceApiModel.invoiceTotal??0),
                        SizedBox(height: 16.h),
                        _noteWidget(),
                      ],
                    ),
