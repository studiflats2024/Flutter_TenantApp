...
class PaymentMethodsWidget extends BaseStatelessWidget {
  ...
  Widget baseBuild(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          // _methodWidget(translate(LocalizationKeys.paypal)!,
          //     AppAssetPaths.paypalLogo, payWithPaypalClickedCallBack)
