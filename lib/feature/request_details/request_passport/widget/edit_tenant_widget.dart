...
class EditTenantWidget extends BaseStatefulWidget {
  final GuestsRequestModel guestsRequestModel;
  void Function(GuestsRequestModel guestsRequestModel) saveCallBack;
  EditTenantWidget({
  ...
  @override
  BaseState<EditTenantWidget> baseCreateState() => _EditTenantWidgetState();
}

class _EditTenantWidgetState extends BaseState<EditTenantWidget> {
