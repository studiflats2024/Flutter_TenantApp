...
class FilterMultiDestinationWidget extends BaseStatefulWidget {
  void Function(List<AreaModel>) changeDestinationCallBack;
  ...
  @override
  BaseState<FilterMultiDestinationWidget> baseCreateState() =>
      _FilterMultiDestinationWidgetState();
}

class _FilterMultiDestinationWidgetState
    extends BaseState<FilterMultiDestinationWidget> {
  List<AreaModel> selectedDestination = [];
  @override
  void initState() {
    ...
    return Builder(builder: (context) {
      return Column(
        ...
        children: [
          ...
          MultiSelectDropDown<AreaModel>(
            selectedOptions: selectedDestination
                .map((e) => ValueItem<AreaModel>(label: e.areaName, value: e))
                .toList(),
            onOptionSelected: _changeArea,
            options: widget.area
                .map((e) => ValueItem<AreaModel>(label: e.areaName, value: e))
                .toList(),
  ...
  void _changeArea(List<ValueItem<AreaModel>> selectedOptions) {
