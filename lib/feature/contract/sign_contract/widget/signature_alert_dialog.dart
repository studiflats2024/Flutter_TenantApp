...
Future<void> showSignatureAlertDialog({
  required BuildContext context,
}) async {
  var widget = SignatureAlertDialog();
  await showAppDialog(
    context: context,
    dialogWidget: widget,
    shouldPop: true,
...
class SignatureAlertDialog extends BaseStatelessWidget {
            ...
            Padding(
              ...
              child: Text(
                translate(LocalizationKeys
                    .pleaseNoteYourBookingIsNotCompletedWithoutYourSignaturePleaseSignIt)!,
                textAlign: TextAlign.center,
                style: const TextStyle(
                  color: Color(0xFF1B1B2F),
                  fontSize: 16,
