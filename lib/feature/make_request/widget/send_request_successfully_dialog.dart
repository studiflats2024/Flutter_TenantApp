...
Future<void> showSendRequestSuccessfullyDialog({
  required BuildContext context,
  required VoidCallback goBackCallback,
  String? message,
}) async {
  var widget = SendRequestSuccessfullyDialog(
...
class SendRequestSuccessfullyDialog extends BaseStatelessWidget {
  final VoidCallback goBackCallback;
  final String? message;
  SendRequestSuccessfullyDialog({
    super.key,
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                message ??
                    translate(
                        LocalizationKeys.yourRequestHasBeenSuccessfullySent)!,
                textAlign: TextAlign.center,
                style: const TextStyle(
                  color: Color(0xFF1B1B2F),
                  fontSize: 16,
