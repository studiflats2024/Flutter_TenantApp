// ignore_for_file: library_private_types_in_public_api, prefer_initializing_formals

import 'package:flutter/widgets.dart';

typedef _TextChanged = void Function(String? text);
typedef _FocusChanged = void Function(bool? focused);
...
class TextFieldState {
  ...
  void _updateController(
      TextEditingController? widgetController, String? text) {
