...
class OffersBookingsWidget extends StatelessWidget {
  OffersBookingsWidget({Key? key}) : super(key: key);
        ...
        listener: (context, state) {
          ...
          if (state is BookingsErrorState) {
            showFeedbackMessage(state.isLocalizationKey
                ...
                : state.errorMassage);
          } else if (state is BookingsOffersLoadedState) {
  ...
  Widget _wishlistWidget() {
    return BlocBuilder<BookingsBloc, BookingsState>(
      builder: (context, state) {
        if (state is BookingsOffersLoadedState) {
