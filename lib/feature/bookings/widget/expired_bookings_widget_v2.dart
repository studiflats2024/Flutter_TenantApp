...
class ExpiredBookingsWidgetV2 extends StatelessWidget {
  ExpiredBookingsWidgetV2({Key? key}) : super(key: key);
        ...
        listener: (context, state) {
          ...
          if (state is BookingsErrorState) {
            showFeedbackMessage(state.isLocalizationKey
                ...
                : state.errorMassage);
          } else if (state is BookingsExpiredLoadedStateV2) {
  ...
  Widget _wishlistWidget() {
    return BlocBuilder<BookingsBloc, BookingsState>(
      builder: (context, state) {
        if (state is BookingsExpiredLoadedStateV2) {
