...
class BookingUintWidgetV2 extends BaseStatefulWidget {
  const BookingUintWidgetV2({
    required this.apartmentBookingModel,
    required this.cardClickCallback,
    super.key,
  });
  final Function(BookingModel model) cardClickCallback;
  final BookingModel apartmentBookingModel;

  @override
  BaseState<BookingUintWidgetV2> baseCreateState() => _UintWidgetState();
}

class _UintWidgetState extends BaseState<BookingUintWidgetV2> {
  @override
        ...
        children: [
          ...
          PositionedDirectional(
              ...
              child: Container(
                ...
                child: Text(
                  widget.apartmentBookingModel.bookingStatus,
  ...
  Widget _titleWidget() {
    return Text(
      widget.apartmentBookingModel.apartmentName,
      maxLines: 1,
  ...
  Widget _locationWidget() {
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: Text(
            widget.apartmentBookingModel.apartmentLocation,
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
            style: const TextStyle(
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                widget.apartmentBookingModel.checkIn,
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                widget.apartmentBookingModel.checkOut,
                // AppDateFormat.formattingMonthDay(
